package j.javacodingproblems.Chapter07.P151_InstantiateViaReflectedConstructor;
...
public class Main {
    ...
    public static void main(String[] args) throws ReflectiveOperationException, MalformedURLException, FileNotFoundException {
