package j.javacodingproblems.Chapter01.P10_GeneratePermutations;
...
public final class Strings {
    ...
    public static void permuteAndPrint(String str) {
        if (str == null || str.isBlank()) { // or throw IllegalArgumentException
            return;
        }
        permuteAndPrint("", str);
    }
    ...
    public static Stream<String> permuteAndReturnStream(String str) {
        ...
        return IntStream.range(0, str.length())
                ...
                .boxed()
                .flatMap(
                        i -> permuteAndReturnStream(str.substring(0, i) + str.substring(i + 1))
