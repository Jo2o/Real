package j.problems.ch02jmisc.P53_CloningObjects.challenge;
...
import j.problems.ch02jmisc.P53_CloningObjects.challenge.shallow.copy.matrix.Matrices;
...
public class Main {
    ...
    public static void main(String[] args) throws CloneNotSupportedException {
        ...
        System.out.println("\nShallow copy via manual copy:");
        j.problems.ch02jmisc.P53_CloningObjects.challenge.shallow.copy.manually.Point point1
                = new j.problems.ch02jmisc.P53_CloningObjects.challenge.shallow.copy.manually.Point(5, 5);

        System.out.println("Point 1 (original), (x, y): " + point1.getX() + ", " + point1.getY());
        j.problems.ch02jmisc.P53_CloningObjects.challenge.shallow.copy.manually.Point clone1
                = point1.clonePoint();
        point1.setX(10);
        point1.setY(10);
        ...
        System.out.println("\nShallow copy via the clone() method:");
        j.problems.ch02jmisc.P53_CloningObjects.challenge.shallow.copy.clone.Point point2
                = new j.problems.ch02jmisc.P53_CloningObjects.challenge.shallow.copy.clone.Point(5, 5);

        System.out.println("Point 2 (original), (x, y): " + point2.getX() + ", " + point2.getY());
        j.problems.ch02jmisc.P53_CloningObjects.challenge.shallow.copy.clone.Point clone2
                = point2.clone();
        point2.setX(10);
        point2.setY(10);
        ...
        System.out.println("\nShallow copy via constructor:");
        j.problems.ch02jmisc.P53_CloningObjects.challenge.shallow.copy.constructor.Point point3
                = new j.problems.ch02jmisc.P53_CloningObjects.challenge.shallow.copy.constructor.Point(5, 5);

        System.out.println("Point 3 (original), (x, y): " + point3.getX() + ", " + point3.getY());
        j.problems.ch02jmisc.P53_CloningObjects.challenge.shallow.copy.constructor.Point clone3
                = new j.problems.ch02jmisc.P53_CloningObjects.challenge.shallow.copy.constructor.Point(point3);
        point3.setX(10);
        point3.setY(10);
        ...
        j.problems.ch02jmisc.P53_CloningObjects.challenge.deep.copy.cloning.Radius radius4
                = new j.problems.ch02jmisc.P53_CloningObjects.challenge.deep.copy.cloning.Radius();
        radius4.setStart(0);
        radius4.setEnd(10);
        j.problems.ch02jmisc.P53_CloningObjects.challenge.deep.copy.cloning.Point point4
                = new j.problems.ch02jmisc.P53_CloningObjects.challenge.deep.copy.cloning.Point(5, 5, radius4);
        ...
        j.problems.ch02jmisc.P53_CloningObjects.challenge.deep.copy.cloning.Point clone4
        ...
        System.out.println("\nDeep copy via SerializationUtils:");
        j.problems.ch02jmisc.P53_CloningObjects.challenge.deep.copy.serialization.Radius radius5
                = new j.problems.ch02jmisc.P53_CloningObjects.challenge.deep.copy.serialization.Radius();
        radius5.setStart(0);
        radius5.setEnd(10);
        j.problems.ch02jmisc.P53_CloningObjects.challenge.deep.copy.serialization.Point point5
                = new j.problems.ch02jmisc.P53_CloningObjects.challenge.deep.copy.serialization.Point(5, 5, radius5);
        ...
        j.problems.ch02jmisc.P53_CloningObjects.challenge.deep.copy.serialization.Point clone5
        ...
        System.out.println("\nDeep copy via serialization helper method:");
        j.problems.ch02jmisc.P53_CloningObjects.challenge.deep.copy.serialization.Radius radius6
                = new j.problems.ch02jmisc.P53_CloningObjects.challenge.deep.copy.serialization.Radius();
        radius6.setStart(0);
        radius6.setEnd(10);
        j.problems.ch02jmisc.P53_CloningObjects.challenge.deep.copy.serialization.Point point6
                = new j.problems.ch02jmisc.P53_CloningObjects.challenge.deep.copy.serialization.Point(5, 5, radius6);
        ...
        j.problems.ch02jmisc.P53_CloningObjects.challenge.deep.copy.serialization.Point clone6
        ...
        j.problems.ch02jmisc.P53_CloningObjects.challenge.deep.copy.serialization.Radius radius7
                = new j.problems.ch02jmisc.P53_CloningObjects.challenge.deep.copy.serialization.Radius();
        radius7.setStart(0);
        radius7.setEnd(10);
        j.problems.ch02jmisc.P53_CloningObjects.challenge.deep.copy.serialization.Point point7
                = new j.problems.ch02jmisc.P53_CloningObjects.challenge.deep.copy.serialization.Point(5, 5, radius7);
        ...
        j.problems.ch02jmisc.P53_CloningObjects.challenge.deep.copy.serialization.Point clone7
